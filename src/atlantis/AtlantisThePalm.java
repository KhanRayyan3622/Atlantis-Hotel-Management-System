...
public class AtlantisThePalm extends JFrame {
    AtlantisThePalm() {
        setSize(1280, 680); // Frame Size
        setLocation(0, 5); // Frame Location
        getContentPane().setBackground(Color.WHITE);
        setTitle("Atlantis The Palm");
        ...
        ImageIcon capture1 = new ImageIcon(ClassLoader.getSystemResource("icons/AtlantisThePalm1.png"));
        JLabel image1 = new JLabel(capture1);
        image1.setBounds(0, -30, 1280, 680);
        imagePanel.add(image1);

        // Load and add second image
        ImageIcon capture2 = new ImageIcon(ClassLoader.getSystemResource("icons/AtlantisThePalm2.png"));
        JLabel image2 = new JLabel(capture2);
        image2.setBounds(0, 650, 1280, 680);
        imagePanel.add(image2);

        // Load and add third image
        ImageIcon capture3 = new ImageIcon(ClassLoader.getSystemResource("icons/AtlantisThePalm3.png"));
