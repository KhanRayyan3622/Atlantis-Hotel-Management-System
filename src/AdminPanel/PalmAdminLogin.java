...
public class PalmAdminLogin extends JFrame implements ActionListener {
    JTextField username;
    ...
    PalmAdminLogin(){
        ...
        ImageIcon palmLogin = new ImageIcon(ClassLoader.getSystemResource("icons/PalmLoginAdmin.png"));
        ...
        if (e.getSource() == loginButton) {
            ...
            try {
                ...
                if ((user.equals(enteredid)) && (pass.equals(enteredcode))) {
                    ...
                    PalmAdminLogin.this.setVisible(false);
