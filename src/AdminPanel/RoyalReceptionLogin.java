...
public class RoyalReceptionLogin extends JFrame implements ActionListener {
    JTextField username;
    ...
    RoyalReceptionLogin(){
        ...
        ImageIcon royalLogin = new ImageIcon(ClassLoader.getSystemResource("icons/RoyalLoginReception.png"));
        ...
        if (e.getSource() == loginButton) {
            ...
            try {
                ...
                if ((user.equals(enteredid)) && (pass.equals(enteredcode))) {
                    ...
                    RoyalReceptionLogin.this.setVisible(false);
